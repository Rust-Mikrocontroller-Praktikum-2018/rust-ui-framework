...
fn main(hw: board::Hardware) -> ! {
    ...
    scope(
        ...
        |interrupt_table| {
            ...
            let mut model = graphics::gui::generate_model();
            let mut active_widget: Option<usize> = None;
            let mut widgets: Vec<Box<UIComponent>> = graphics::gui::view(&model);
            ...
            loop{
                ...
                if new_msg.is_some(){
                    ...
                    model = graphics::gui::update(model, msg);
                    let new_widgets = graphics::gui::view(&model);
